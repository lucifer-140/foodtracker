            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    @forelse ($friends as $friend)
                        <a href="{{ route('users.show', $friend) }}" class="bg-white rounded-xl shadow-lg flex flex-col text-center transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-2xl">
