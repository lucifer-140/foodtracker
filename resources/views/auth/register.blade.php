<x-guest-layout>
        ...
        <div class="w-full max-w-md animate-fade-in">
            ...
            <div class="glass-card rounded-3xl shadow-xl p-8">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <x-text-input 
                            ...
                            class="block mt-1 w-full px-4 py-3 text-gray-900 placeholder-gray-500"
                            required 
                            autofocus 
                            autocomplete="name"
                        />
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <x-text-input 
                                ...
                                class="block mt-1 w-full px-4 py-3 pr-12 text-gray-900 placeholder-gray-500"
                                required 
                                autocomplete="new-password"
                            />
                            <button type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-600" onclick="togglePassword('password')">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <x-text-input 
                                ...
                                required 
                            />
                            <button type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-600" onclick="togglePassword('password_confirmation')">
                ...
                <div class="text-center">
                    @if (Route::has('login'))
                        <a href="{{ route('login') }}" class="link-green font-medium">
                            {{ __('Sign in here') }}
                        </a>
                    @endif
                </div>
    ...
    function togglePassword(field) {
        ...
        const eyeOpen = document.getElementById(`eye-open-${field}`);
        const eyeClosed = document.getElementById(`eye-closed-${field}`);
