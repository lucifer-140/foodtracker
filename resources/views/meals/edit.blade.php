<x-app-layout>
    ...
    <script>
        ...
        // Start the index AFTER the last existing ingredient
        let ingredientIndex = {{ $meal->ingredients->count() }};

        function addIngredientRow() {
            // This function is identical to the one on the create page
            ...
            newRow.innerHTML = `
                ...
                <div class="w-1/12"><x-danger-button type="button" onclick="this.closest('[data-ingredient-row]').remove()">X</x-danger-button></div>
            `;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            // Find all the ingredient rows that were rendered by Blade
            const existingRows = document.querySelectorAll('[data-ingredient-row]');
            // Initialize the dropdown logic for each of them
